...
const MobileBottomNav: React.FC<{
  ...
  return (
    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-gray-200 px-2 py-2 z-50  lg:hidden shadow-2xl">
          ...
          <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              ...
              <nav className="hidden lg:flex items-center space-x-1">
                <Link
                  to="/"
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${isActivePath('/') ? 'bg-black text-white' : 'text-gray-700 hover:bg-gray-100'
                    }`}
                >
                  Home
                </Link>
                <Link
                  to="/products"
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${isActivePath('/products') ? 'bg-black text-white' : 'text-gray-700 hover:bg-gray-100'
                    }`}
                >
                  All Products
                </Link>
                <Link
                  to="/about"
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${isActivePath('/about') ? 'bg-black text-white' : 'text-gray-700 hover:bg-gray-100'
                    }`}
                >
                  About
                </Link>
              ...
              <div className="overflow-y-auto h-[calc(100vh-73px)]">
                ...
                <div className="p-4 space-y-2">
                  <Link
                    to="/"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-all ${isActivePath('/') ? 'bg-black text-white' : 'hover:bg-gray-100'
                      }`}
                  >
                  ...
                  <Link
                    to="/products"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-all ${isActivePath('/products') ? 'bg-black text-white' : 'hover:bg-gray-100'
                      }`}
                  >
                  ...
                  <Link
                    to="/about"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-all ${isActivePath('/about') ? 'bg-black text-white' : 'hover:bg-gray-100'
                      }`}
                  >
