...
function Smartessentialsection() {
    return (
        <div className='flex md:flex-row flex-col items-center justify-center md:gap-3 gap-9 py-10'>

            <div className="left text-center md:w-[33%] w-[100%]">
                <div className='flex justify-center py-2'>
                    <svg width="60" height="60" viewBox="0 0 60 60" fill="none">
                        <circle cx="30" cy="30" r="29.25" stroke="currentColor" stroke-width="1.5"></circle>
                ...
                <div>
                    <h1 className='text-[20px] font-semibold md:py-4 py-2'>
                        Ethical Living
                    </h1>
            ...
            <div className="middle text-center md:w-[33%] w-[100%]">
                ...
                <div>
                    <p>
                        Discover cruelty-free products across beauty and lifestyle categories.
                    </p>
                </div>

            </div>

            <div className="right text-center md:w-[33%] w-[100%]">
                <div className='flex justify-center  py-2'>
                    <svg width="60" height="60" viewBox="0 0 60 60" fill="none">
                        <path d="M59.25 30C59.25 46.1543 46.1543 59.25 30 59.25C13.8457 59.25 0.75 46.1543 0.75 30C0.75 13.8457 13.8457 0.75 30 0.75C46.1543 0.75 59.25 13.8457 59.25 30Z" stroke="currentColor" stroke-width="1.5"></path>
                ...
                <div className='px-2'>
                    <p>
                        Quality essentials for your car, kitchen, mobile, and self-care needs.
                    </p>
                </div>
...
export default Smartessentialsection
