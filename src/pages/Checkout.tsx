  ...
  const onPlaceOrder = async () => {
    ...
    try {
      ...
      const orderData = {
        ...
        currency: checkoutItems[0]?.currency || 'AED',
                  ...
                  <div className="p-4 bg-gray-50">
                    <div className="space-y-4 text-sm">
                      ...
                      <div className="border-t pt-3">
                        <p className="text-base text-gray-600"><strong>Step 2 - Product Payment:</strong> Pay <strong>{currency} {total.toFixed(2)}</strong> (product amount) on delivery.</p>
                      </div>
                    </div>
                  </div>
                </div>
